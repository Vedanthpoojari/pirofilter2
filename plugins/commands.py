...
async def start(client, message):
        ...
        for msg in msgs:
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚡ Official Channel ⚡', url="https://telegram.me/MoviesCenterOfficial") ] ] ),
    ...
    if not files_:
        ...
        try:
            msg = await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️⚡ Official Channel ⚡', url="https://telegram.me/MoviesCenterOfficial") ] ] ),
            )
            filetype = msg.media
    ...
    await client.send_document(chat_id, document="your_file_path_or_url")
        chat_id=message.from_user.id,
        file_id=file_id,
        caption=f_caption,
        protect_content=True if pre == 'filep' else False,
